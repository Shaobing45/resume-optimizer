...
export default function DarkModeToggle() {
  ...
  return (
    <button onClick={toggle} className="rounded-lg p-2 text-sm text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 transition-colors" title="切换暗黑模式" aria-label="切换暗黑模式">
