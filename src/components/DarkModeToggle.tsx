...
export default function DarkModeToggle() {
  ...
  return (
    <button onClick={toggle} className="rounded-lg p-2 text-sm text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 transition-colors" title="鍒囨崲鏆楅粦妯″紡" aria-label="鍒囨崲鏆楅粦妯″紡">
